...
function optionsframework_add_admin(){
	...
	$icon = ADMIN_DIR . 'assets/images/favicon.png';

	// Theme Options page
	
	$of_page = add_object_page( THEMENAME, 'Realto Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page',$icon);
